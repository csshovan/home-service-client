    ...
    return (
        <section className="bg-yellow-50 p-4 rounded-lg">
            <div className="text-center mb-4 ">
                ...
                <p className="md:max-w-xl mx-auto text-p-font text-base px-2 md:px-0 font-semibold italic">
                Our friendly and knowledgeable staff is available during our business hours to respond to your inquiries and schedule services. We look forward to hearing from you and are committed to ensuring your home service needs are met with excellence.
                </p>
            </div>
            {/* Flex section */}
