    ...
    return (
        <div className="my-10">
            <footer className="px-4 divide-y bg-gray-200">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3">
                        <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                            ...
                            <span className="self-center text-2xl font-semibold">Home Care
                            </span>
                        </a>
                    </div>
                    <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                        ...
                        <div className="space-y-3">
                            ...
                            <ul className="space-y-1">
                                <li>
                                    <a rel="noopener noreferrer" href="#">+880128293</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" href="#">home@care.com</a>
                                </li>
                                <li>
                ...
                <div className="py-6 text-sm text-center dark:text-gray-400">© 2023 Home Care All rights reserved.</div>
            </footer>
